...
void tft_lvgl_layer_init(void)
{
    ...
    static lv_color_t tft_disp_buf1[TFT_LVGL_LAYER_DISP_HOR_RES*60];
    static lv_color_t tft_disp_buf2[TFT_LVGL_LAYER_DISP_HOR_RES*60];
    ...
    lv_disp_draw_buf_init(&tft_disp_buf, tft_disp_buf1, tft_disp_buf2, TFT_LVGL_LAYER_DISP_HOR_RES*60);
